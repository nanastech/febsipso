...
//////////////////////////////////////////Menu Outline /////////////////////////////////////
	...
	public function revisi_outline($data=null){
		...
		if ($this->Model->update_data($data_update,'nim',$data,'outline') && $this->Model->create('info',$data_info) && $this->Model->duplicate('nim',$data,'outline','log_outline')&& $this->Model->update_data($data_dospem,'nim',$data,'dospem') && $this->Model->update_data($data_skripsi,'nim',$data,'judul_skripsi')) {
			redirect(base_url('Kaprodi/status_outline/'));	
		}else{
			echo "GAGAL";
		}
