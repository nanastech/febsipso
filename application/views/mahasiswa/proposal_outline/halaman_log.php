                              ...
                              <div class="modal-body col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  if ($log_outline['jurusan']=='DAK') {
                                    ...
                                    }elseif ($log_outline['jurusan']=='SA') {
                                      echo 'S1 Akuntasi';
                                    }elseif ($log_outline['jurusan']=='SM') {
                                      echo 'S1 Manajemen';
                                    }elseif ($log_outline['jurusan']=='EKS') {
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <?php 
                                    $dosen=$this->Model->read_detail('noreg',$log_outline['dospem'],'dosen');
                                  ?>
                                ...
                                <div class="form-group col-md-6">
                                  <span class="glyphicon glyphicon-pawn"></span><label>&nbsp;&nbsp;Dosen Pembimbing</label>
                                  <?php 
                                    $dosens=$this->Model->read_detail('noreg',$log_outline['dospems'],'dosen');
                                  ?>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body col-md-12">
                                <div class="form-group col-md-12">
                                  ...
                                  <br/>
                                  <img src="<?=base_url('uploads/outline/'.$log_outline['ufmhs'])?>" onerror="this.src='<?= $notfound; ?>'" height="320px">
                                </div>
                                <div class="form-group col-md-12">
                                  <span class="fa fa-check-circle-o"></span><label>&nbsp;&nbsp;Slip Bimbingan Skripsi :</label>
                                  <br/>
                                  <img src="<?=base_url('uploads/outline/'.$log_outline['usbs'])?>" onerror="this.src='<?= $notfound; ?>'" style="width:100%;max-width:560px;">
                                </div>
                                <div class="form-group col-md-12">
                                  <span class="fa fa-check-circle-o"></span><label>&nbsp;&nbsp;Slip Pendaftaran Ulang :</label>
                                  <br/>
                                  <img src="<?=base_url('uploads/outline/'.$log_outline['uspu'])?>" onerror="this.src='<?= $notfound; ?>'" style="width:100%;max-width:560px;">
                                </div>
                                <div class="form-group col-md-12">
                                  <span class="fa fa-check-circle-o"></span><label>&nbsp;&nbsp;KST :</label>
                                  <br/>
                                  <img src="<?=base_url('uploads/outline/'.$log_outline['ukst'])?>" onerror="this.src='<?= $notfound; ?>'" style="width:100%;max-width:560px;">
                                </div>
                                <div class="form-group col-md-12">
                                  <span class="fa fa-check-circle-o"></span><label>&nbsp;&nbsp;Transkrip Nilai :</label>
                                  <br/>
                                  <img src="<?=base_url('uploads/outline/'.$log_outline['utn'])?>" onerror="this.src='<?= $notfound; ?>'" style="width:100%;max-width:560px;">
                                </div>
                                <div class="form-group col-md-12">
