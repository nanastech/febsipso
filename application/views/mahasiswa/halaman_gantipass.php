...
<head>
  ...
  <title>SIPSO | Ganti Password</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form method="POST" action="<?php echo base_url('Mahasiswa/ganti_password/');?>">
        ...
        <div class="box-footer" align="center">
          ...
          <a type="button" href="<?= base_url('Mahasiswa')?>" class="btn btn-default">Cancel</a>
        </div>
        </form>
        <!-- /.box-footer-->
      </div>
