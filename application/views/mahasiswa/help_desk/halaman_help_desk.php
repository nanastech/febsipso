  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a class="active">Help Desk</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body table-responsive">
          ...
          <div class="col-md-12">
            <form action="<?php echo base_url('Mahasiswa/proses_help_desk/'.$this->session->userdata('username')); ?>" method="POST">
...
<script>
  ...
  var formulir = document.getElementById("helpdesk");
