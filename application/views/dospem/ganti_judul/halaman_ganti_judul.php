        ...
        <div class="box-body table-responsive">
          <div class="col-md-12">
            ...
            <table id="example1"  class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $ganti_judul=$this->Model->status_ganti_judul_dospem($this->session->userdata('username'));
                $no=1;
                if ($ganti_judul) {
                    ...
                    <tr>
                      ...
                      <td align="center" style="vertical-align: middle;">
                        ...
                        if (empty($id['accdospem'])) {
                          echo '<a type="button" class="btn btn-primary" href="'.base_url('Dospem/validasi_ganti_judul/'.$id['nim'].'/'.$id['id_ganti']).'" > Approve</a>';
                        }else{
