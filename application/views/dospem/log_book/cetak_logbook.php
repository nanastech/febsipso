...
<head>
  <meta charset="utf-8">
  <title>Cetak Log Book Bimbingan <?=base64_decode($this->uri->segment(3))?></title>
  <style>
  @page { 
    size:auto; 
    margin-top: 4cm;
...
<?php 
$dospem=$this->Model->read_detail('nim',$nim,'dospem');
...
<div class="page">
    ...
    <tr>
      ...
      <td colspan="7"><strong>[<?=$nim?>] <?=$outline->nama?></strong></td>
    </tr>
    <tr>
