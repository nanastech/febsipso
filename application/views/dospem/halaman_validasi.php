...
<head>
  ...
  <title>SIPSO | Validasi Pendaftaran Sidang</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Validasi Status</li>
      </ol>
    </section>
            ...
            <div class="box-body">
             <table class="table table-condensed">
                <tr>
                  ...
                  <th style="width: 140px; text-align: center;">Peserta Sidang</th>
                  <th style="width: 140px; text-align: center;">Dosen Pembimbing</th>
                  <th style="width: 140px; text-align: center;">Kepala Program Studi</th>
                </tr>
                <?php $mahasiswas = $this->Model->read_where('noreg',$this->session->userdata('username'),'daftar_sidang');
                if (empty($mahasiswas)) {
                	echo "Data Kosong";
                }else{
                $no1=1;
                ...
                <tr>
                  ...
                  <?php $form=$this->Model->read_detail('nim',$mahasiswa['nim'],'daftar_sidang');
                  	?>
                  <td style="vertical-align: middle; text-align: center;"><button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg<?=$mahasiswa['nim'];?>"><?= '('.$mahasiswa['nim'].') '.$mahasiswa['nama'];?></button></td>
                  <!-- Large modal -->
                          ...
                          <div class="modal-body">
                            ...
                            <legend>Slip Daftar Ulang Terakhir</legend>
                              <div class="form-group ">
                                <img style="height: 200px; margin: auto;" src="<?php echo base_url('Dospem/gambar_slipdut/'.$mahasiswa['nim'].'/'); ?>" />
                              </div>
                            <legend>Slip Bimbingan Skripsi</legend>
                            <div class="form-group ">
                              <img style="height: 200px; margin: auto;" src="<?php echo base_url('Dospem/gambar_slipbs/'.$mahasiswa['nim'].'/'); ?>" />
                            </div>

                            <legend>Slip Ujian Skripsi</legend>
                            <div class="form-group ">
                              <img style="height: 200px; margin: auto;" src="<?php echo base_url('Dospem/gambar_slipus/'.$mahasiswa['nim'].'/'); ?>" />
                            </div>
                            ...
                            <?php if (empty($form->slipps)) {
                              ...
                              <img style="height: 200px; margin: auto;" src="<?php echo base_url('Dospem/gambar_slipps/'.$this->session->userdata('username').'/'); ?>" />
                            <?php }?>
                            </div>
                          </div>
                  ...
                  <td style="vertical-align: middle; text-align: center;">
                    <?php 
                  	if (empty($form->accdospem)) {
                  		echo '<a type="button" class="btn btn-primary" href="'.base_url('Dospem/validated/'.$form->nim).'"> Validasi</a>';
                  	}else{
                  		echo '<a type="button" class="btn btn-success" href=""> Validated</a>';
                  	}
                  	?>
                  </td>
                  <td style="vertical-align: middle; text-align: center;">
