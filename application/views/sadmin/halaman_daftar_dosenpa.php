      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo base_url('Superadmin/daftar_dosenpa/daftar'); ?>" method="POST">
              <div class="box-body">
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="<?php echo base_url('Superadmin/daftar_dosenpa/update'); ?>" method="POST">
