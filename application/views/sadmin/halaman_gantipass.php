...
<?php $this->load->view('Sadmin/layout/menu'); ?>	
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>Sadmin/"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form method="POST" action="<?php echo base_url('Superadmin/ganti_password/');?>">
        ...
        <div class="box-footer" align="center">
          ...
          <a type="button" href="<?= base_url('Sadmin')?>" class="btn btn-default">Cancel</a>
        </div>
        </form>
        <!-- /.box-footer-->
      </div>
