    ...
    <?php echo $notification; ?>
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Selamat Datang Superadmin!</h3>
        ...
        <div class="box-body">
          NON AKTIF MAHASISWA <a class="btn btn-danger" href="<?= base_url('Superadmin/non_aktif_mhs');?>">GO</a> <br>
          AKTIF MAHASISWA <a class="btn btn-success" href="<?= base_url('Superadmin/aktif_mhs');?>">GO</a> <br><br>


          Masukin Judul Skripsi <a class="btn btn-success" href="<?= base_url('Superadmin/judul_skripsi/');?>">GO</a>		 
        </div>
        <!-- /.box-body -->
