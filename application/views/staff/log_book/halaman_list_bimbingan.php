                ...
                <tbody>
                  ...
                  foreach ($mahasiswas as $mahasiswa) { 
                    ...
                    <tr>
                      ...
                      <td align="center" style="vertical-align: middle;"><a href="<?= base_url('Staff/detail_logbook/'.base64_encode($mahasiswa['nim']));?>" class="btn btn-primary btn-xs"><span class="fa fa-book"></span>&nbsp;&nbsp;Log Book</a></td>
                    </tr>
                  <?php
                  $no1++; 
                      }  
