    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          ?>
          <form method="POST" action="<?php echo base_url('Staff/createjadwal/'.$nim);?>">
              ...
              <div class="form-group col-md-4">
                ...
                <select class="form-control" name="penguji1">
                  <?php $dosens=$this->Model->read('dosen_pembimbing');
              ...
              <div class="form-group col-md-4">
                <label class="control-label">Penguji III/Pembimbing :</label>
                <input type="text" readonly="" class="form-control" name="pembimbing" value="<?=$outline->Dosen_Pembimbing;?>">
              </div>
        ...
        <div class="box-footer" align="center">
          ...
          <a type="button" href="<?= base_url('Staff/jadwal/')?>" class="btn btn-default">Cancel</a>
        </div>
        </form>
        <!-- /.box-footer-->
      </div>
