...
<head>
  ...
  <title>SIPSO | Berita Acara Sidang</title>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php $jadwals = $this->Model->read_orderby1('jadwal_sidang','no_surat','DESC');
                if (!empty($jadwals)) {
                  $no1=1;
                  foreach ($jadwals as $jadwal) { 
                    ...
                    <tr>
                      ...
                      <td style="vertical-align: middle; text-align: center;"><?=date('H.i',strtotime($jadwal['waktu'])) ?></td>
                      ...
                      <td><button class="btn btn-primary btn-xs btn-block" data-toggle="modal" data-target=".bs-example-modal-sm<?= $jadwal['nim'] ?>"><span class="fa fa-plus"></span>&nbsp;&nbsp;No. Surat</button><br><a class="btn btn-danger btn-xs btn-block" target="_blank" href="<?= base_url('Staff/cetak_surat_sidang/'.base64_encode($jadwal['nim'])) ?>"><span class="fa fa-file-pdf-o"></span>&nbsp;&nbsp;Cetak 1</a><br><a class="btn btn-danger btn-xs btn-block" target="_blank" href="<?= base_url('Staff/cetak_surat_hasil_sidang/'.base64_encode($jadwal['nim'])) ?>"><span class="fa fa-file-pdf-o"></span>&nbsp;&nbsp;Cetak 2</a></td>
                        <!-- Small modal -->
                        <div class="modal fade bs-example-modal-sm<?= $jadwal['nim'] ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <form action="<?= base_url('staff/update_nosurat_sidang/'.$jadwal['nim'])?>" method="POST">
                              <div class="modal-body col-md-12">
                                <div class="form-group col-md-12">
                                  <span class="fa fa-check-circle-o"></span><label>&nbsp;&nbsp;Nomor Surat : </label>
                                  <input type="text" name="no_surat" class="form-control" value="<?= $jadwal['no_surat']?>" required="" > 
                                </div>
