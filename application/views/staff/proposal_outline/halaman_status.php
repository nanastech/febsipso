  ...
  <link rel="stylesheet" href="<?= base_url(); ?>assets/plugins/materialdatetimepicker/css/bootstrap-material-datetimepicker.css" />
  ...
  <script type="text/javascript" src="<?= base_url(); ?>assets/plugins/materialdatetimepicker/js/bootstrap-material-datetimepicker.js"></script>
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="col-md-12">
                ...
                <div class="col-md-10">
                  <form method="POST" action="<?= base_url('Staff/excel_draft_outline/'); ?>" target="_blank">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body col-md-12">
                                  ...
                                  <div class="form-group col-md-6">
                                    ...
                                    <textarea required="" readonly="" class="form-control" name="topik1" rows="3" placeholder="Masukan Topik 1"><?= $form->topik1; ?></textarea>
                                  </div>
                                  <!-- topik2 -->
                                  <div class="form-group col-md-6">
                                    <span class="glyphicon glyphicon-flag"></span><label>&nbsp;&nbsp;Topik 2</label>
                                    <textarea required="" readonly="" class="form-control" name="topik2" rows="3" type="text" placeholder="Masukan Topik 2"><?= $form->topik2; ?></textarea>
                                  </div>
                                  <!-- dospem -->
                                  <div class="form-group col-md-6">
