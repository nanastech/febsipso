        ...
        <div class="box-body table-responsive">
          <div class="col-md-12">
            ...
            <table id="example1"  class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $ganti_judul=$this->Model->status_ganti_judul_kaprodi($this->session->userdata('prodi'));
                $no=1;
                if ($ganti_judul) {
                    ...
                    <tr>
                      ...
                      <td align="center" style="vertical-align: middle;">
                        ...
                        if (empty($id['acckaprodi'])) {
                          echo '<button data-toggle="modal" data-target=".bs-example-modal-sm_app'.$id['id_ganti'].'"  class="btn btn-primary"> Approve</button>';
                        }else{
                      ...
                      <!-- Small modal -->
                      <div class="modal fade modal-warning bs-example-modal-sm_app<?=$id['id_ganti']?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <strong><h4>Ingin <strong>APPROVE</strong> permohonan ganti judul skripsi mahasiswa [ <?= $id['nim']?> ] <?=$Mahasiswa->nama;?>?!</h4></strong>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-outline" data-dismiss="modal">Cancel</button>
                              <a type="button" class="btn btn-primary pull-left" href="<?php echo base_url('Kaprodi/validasi_ganti_judul/'.$id['nim'].'/'.$id['id_ganti']); ?>">Approve</a>
                            </div>
                          </div>
                        </div>
                      </div>
