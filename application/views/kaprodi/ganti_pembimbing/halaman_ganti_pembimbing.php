        ...
        <div class="box-body table-responsive">
          <div class="col-md-12">
            ...
            <table id="example1"  class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $ganti_pembimbing=$this->Model->status_ganti_pembimbing_kaprodi($this->session->userdata('prodi'));
                $no=1;
                if ($ganti_pembimbing) {
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <strong><h4>Ingin <strong>APPROVE</strong> permohonan ganti pembimbing skripsi mahasiswa [ <?= $id['nim']?> ] <?=$Mahasiswa->nama;?>?!</h4></strong>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-outline" data-dismiss="modal">Cancel</button>
                              <a type="button" class="btn btn-primary pull-left" href="<?php echo base_url('Kaprodi/validasi_ganti_pembimbing/'.$id['nim'].'/'.$id['id']); ?>">Approve</a>
                            </div>
                          </div>
                        </div>
                      </div>
