...
<head>
  ...
  <title>SIPSiSi | Validasi Pendaftaran Sidang</title>
            ...
            <div class="box-body">
             <table class="table table-condensed">
                <tr>
                  ...
                  <th style="width: 140px">Peserta Sidang</th>
                  <th style="width: 140px">Dosen Pembimbing</th>
                  <th style="width: 140px">Kepala Program Studi</th>
                </tr>
                ...
                <tr>
                  ...
                  <?php $form=$this->Model->read_detail('nim',$mahasiswa['nim'],'daftar_sidang');
                  	?>
                  <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg<?=$mahasiswa['nim'];?>"><?= '('.$mahasiswa['nim'].') '.$mahasiswa['nama'];?></button></td>
                  <!-- Large modal -->
                          ...
                          <div class="modal-body">
                            ...
                            <legend>Slip Daftar Ulang Terakhir</legend>
                              <div class="form-group ">
                                <img style="height: 200px; margin: auto;" src="<?php echo base_url('Kaprodi/gambar_slipdut/'.$mahasiswa['nim'].'/'); ?>" />
                              </div>
                            <legend>Slip Bimbingan Skripsi</legend>
                            <div class="form-group ">
                              <img style="height: 200px; margin: auto;" src="<?php echo base_url('Kaprodi/gambar_slipbs/'.$mahasiswa['nim'].'/'); ?>" />
                            </div>

                            <legend>Slip Ujian Skripsi</legend>
                            <div class="form-group ">
                              <img style="height: 200px; margin: auto;" src="<?php echo base_url('Kaprodi/gambar_slipus/'.$mahasiswa['nim'].'/'); ?>" />
                            </div>
                            ...
                            <?php if (empty($form->slipps)) {
                              ...
                              <img style="height: 200px; margin: auto;" src="<?php echo base_url('Kaprodi/gambar_slipps/'.$this->session->userdata('username').'/'); ?>" />
                            <?php }?>
                            </div>
                          </div>
                  ...
                  <td>
                    <?php 
                  	if (empty($form->accdospem)) {
                  		echo '<a type="button" class="btn btn-primary disabled" href=""> Validasi</a>';
                  	}else{
                  ...
                  <td>
                  	...
                  	if (empty($form->acckaprodi)) {
                  		echo '<a type="button" class="btn btn-primary" href="'.base_url('Kaprodi/validated/'.$form->nim).'"> Validasi</a>';
                  	}else{
