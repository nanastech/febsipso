            ...
            <br/>
              ...
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class=" col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" name="mahasiswa" type="text" readonly="" placeholder="Dosen" value="<?='['.$dosen->noreg.'] '.$dosen->nama;?>">
                    </div>
                ...
                <div class="row" style="padding-bottom: 15px;">
                  ...
                  <div class="col-md-4" align="right"><a target="_blank" class="btn btn-danger" href="<?= base_url('Kaprodi/cetak_logbook/'.$this->uri->segment(3))?>"><span class="fa fa-file-pdf-o"></span>&nbsp;&nbsp;Cetak Log Book</a></div>
                </div>
