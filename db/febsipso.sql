...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2023 at 02:08 PM
...
CREATE TABLE `log_outline` (
  ...
  `accstaff` varchar(10) DEFAULT NULL,
  `tglaccstaff` datetime DEFAULT NULL,
  `accdsnpa` varchar(10) DEFAULT NULL,
  `tglaccdsnpa` datetime DEFAULT NULL,
  `acckaprodi` varchar(10) DEFAULT NULL,
...
INSERT INTO `mahasiswa` (`id`, `nim`, `nama`, `jenjang`, `jurusan`, `tempat`, `tgl_lahir`, `alamat`, `tlp`, `hp`) VALUES
(1, '10082023', 'UserGuide Mahasiswa Akuntansi', 'Strata Satu', 'AK', '', '0000-00-00', '', '', 0);
...
(1, 'lapstaff', '$2a$12$vAZgBEzvyzE.m.1x5Pr0kewpduhIDHEDw58zj13LmbFrIN8cA3DCq', 'Tugas Akhir FEB', 'staff', 'UM', '2023-08-10 14:25:29', '1'),
(2, '10082023', '$2a$12$hzcCp4.RssHWkWk6p6BoCeD0olZQqXs4kDMknRFpiT7EC1iY0BcCa', 'UserGuide Mahasiswa Akuntansi', 'mahasiswa', 'AK', '2023-08-10 14:52:54', '1');
